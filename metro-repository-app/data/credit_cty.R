...
ccu <- c("stco_code", "Average Credit Card Utilization, All", "Average Credit Card Utilization, Majority White Communities", "Average Credit Card Utilization, Communities of Color")
ccu <- credit[ccu]

cc_delinquency <- c("stco_code", "Credit Card Delinquency Rate (30+), All", "Credit Card Delinquency Rate (30+), Majority White Communities", "Credit Card Delinquency Rate (30+), Communities of Color")
cc_delinquency <- credit[cc_delinquency]

sl_delinquency <- c("stco_code", "Student Loan Delinquency Rate (60+), All", "Student Loan Delinquency Rate (60+), Majority White Communities", "Student Loan Delinquency Rate (60+), Communities of Color")
sl_delinquency <- credit[sl_delinquency]

ar_delinquency <- c("stco_code", "Auto/Retail Loan Delinquency Rate (60+), All", "Auto/Retail Loan Delinquency Rate (60+), Majority White Communities", "Auto/Retail Loan Delinquency Rate (60+), Communities of Color")
ar_delinquency <- credit[ar_delinquency]

mort_delinquency <- c("stco_code", "Mortgage Delinquency Rate (30+), All", "Mortgage Delinquency Rate (30+), Majority White Communities", "Mortgage Delinquency Rate (30+), Communities of Color")
mort_delinquency <- credit[mort_delinquency]

afs_credit <- c("stco_code", "Share with AFS Credit, All", "Share with AFS Credit, Majority White Communities", "Share with AFS Credit, Communities of Color")
afs_credit<- credit[afs_credit]

afs_delinquency <- c("stco_code", "AFS Credit Delinquency Rate (30+), All", "AFS Credit Delinquency Rate (30+), Majority White Communities", "AFS Credit Delinquency Rate (30+), Communities of Color")
